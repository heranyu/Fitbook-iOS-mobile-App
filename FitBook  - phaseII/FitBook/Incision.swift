...
/**
 ...
 assessment.
 */
struct Incision: Assessment {
    // MARK: Activity
    
    let activityType: ActivityType = .incision
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Incisions", comment: "")
    ...
    func task() -> ORKTask {
        ...
        let question = NSLocalizedString("Is there any new or increased redness, swelling or drainage from your incisions?", comment: "")
