 ...
 */
struct TotalFat: Assessment, HealthSampleBuilder {
    // MARK: Activity properties
    
    let activityType: ActivityType = .totalfat
    
    // MARK: HealthSampleBuilder Properties
    
    let quantityType = HKQuantityType.quantityType(forIdentifier: HKQuantityTypeIdentifier.dietaryFatTotal)!
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Total Fat", comment: "")
    ...
    func task() -> ORKTask {
        ...
        // Create a question.
        let title = NSLocalizedString("Input your Total Fat", comment: "")
