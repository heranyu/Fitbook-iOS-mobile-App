 ...
 */
struct SaturatedFat: Assessment, HealthSampleBuilder {
    // MARK: Activity properties
    
    let activityType: ActivityType = .saturatedfat
    
    // MARK: HealthSampleBuilder Properties
    
    let quantityType = HKQuantityType.quantityType(forIdentifier: HKQuantityTypeIdentifier.dietaryFatSaturated)!
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Saturated Fat", comment: "")
        let summary = NSLocalizedString("How much you eat today", comment: "Unsaturated fats are preferred over saturated")
    ...
    func task() -> ORKTask {
        ...
        // Create a question.
        let title = NSLocalizedString("Input your Saturated Fat", comment: "")
