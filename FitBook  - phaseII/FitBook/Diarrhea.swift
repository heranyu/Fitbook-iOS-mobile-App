...
/**
 ...
 assessment.
 */
struct Diarrhea: Assessment {
    // MARK: Activity
    
    let activityType: ActivityType = .diarrhea
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Diarrhea", comment: "")
    ...
    func task() -> ORKTask {
        ...
        let question = NSLocalizedString("Do you have diarrhea today?", comment: "")
