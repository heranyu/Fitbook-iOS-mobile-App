 ...
 */
struct PolyunsaturatedFat: Assessment, HealthSampleBuilder {
    // MARK: Activity properties
    
    let activityType: ActivityType = .polyunsaturatedfat
    
    // MARK: HealthSampleBuilder Properties
    
    let quantityType = HKQuantityType.quantityType(forIdentifier: HKQuantityTypeIdentifier.dietaryFatPolyunsaturated)!
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        /*let thresholds = [
            OCKCarePlanThreshold.numericThreshold(withValue: NSNumber.init(value: 1200), type: .numericGreaterThanOrEqual, upperValue: nil, title: "You eat too much today."),
            OCKCarePlanThreshold.numericThreshold(withValue: NSNumber.init(value: 800), type: .numericLessThanOrEqual, upperValue: nil, title: "You can eat more.")] as Array<OCKCarePlanThreshold>;*/
        // Get the localized strings to use for the assessment.
        let title = NSLocalizedString("Polyunsaturated Fat", comment: "")
    ...
    func task() -> ORKTask {
        ...
        // Create a question.
        let title = NSLocalizedString("Input your Polyunsaturated Fat", comment: "")
